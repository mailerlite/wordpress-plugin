        ...
        <div id="post-body">
            <div id="post-body-content">
                <form action="<?php echo admin_url('admin.php?page=mailerlite_main&view=edit&id=' . (isset($_GET['id']) ? $_GET['id'] : 0)); ?>" method="post">
                    ...
                    <input type="text" class="form-large" name="form_name" size="30" maxlength="255" value="<?php echo $form->name; ?>" id="form_name" placeholder="<?php echo __('Form title', 'mailerlite'); ?>">
                    <div>
